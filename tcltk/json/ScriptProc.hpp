...
#ifndef ASCTK_SCRIPTPROC_HPP
#define ASCTK_SCRIPTPROC_HPP

static int Asc_ScriptInterrupt;
/**<
 * The C variable corresponding to the script being interrupted
 * by an interactive user or call with a trapped exception.
 */

int Asc_ScriptConfigureInterrupt(int start, Asc_DString *hptr);
/**<
 * <!--  err = Asc_ScriptConfigureInterrupt(start,hptr);              -->
 * <!--  int err,start;                                                 -->
 ...
 * for details.
 *
 * @param hptr The hptrretter the ascend application is running in.
 * @param start   Is 1 at startup and 0 at shutdown.
 * @return Returns 0 if the call is ok, 1 if the call is not ok.
 */

int Asc_ScriptEvalCmd(Asc_DString *hptr, int argc, CONST84 char *argv[]);
/**<
...
int Asc_ScriptRefineCmd(Asc_DString *hptr, int argc, CONST84 char *argv[]);
/**<
...
int Asc_ScriptMergeCmd(Asc_DString *hptr, int argc, CONST84 char *argv[]);
/**<
...
int Asc_FastRaiseCmd(Asc_DString *hptr, int argc, CONST84 char *argv[]);
/**<
...
int Asc_TimeCmd(Asc_DString *hptr, int argc, CONST84 char *argv[]);
/**<
 *  Timing function.
...
// int Asc_StringCompact(Asc_DString *hptr, int argc, CONST84 char *argv[]);
/**<
