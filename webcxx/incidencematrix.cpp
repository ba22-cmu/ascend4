...
list_IncidencePoint IncidenceMatrix::getIncidenceData_list()
{
	return list_IncidencePoint(getIncidenceData(block));
}

list_Variable IncidenceMatrix::getBlockVars_list(const int &block);
{
	return list_Variable(getBlockVars(block));
}

list_Relation IncidenceMatrix::getBlockRels_list(const int &block);
{
	return list_Relation(getBlockRels(block));
}

list_int IncidenceMatrix::getBlockLocation_list(const int &block) const;
{
	return list_int(getBlockLocation(block));
}
#endif
