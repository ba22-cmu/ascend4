...
list_Relation SingularityInfo::get_rels_list()
{
	return list_Relation(rels);
}

list_Variable SingularityInfo::get_vars_list()
{
	return list_Variable(var());
}

list_Variable SingularityInfo::get_freeablevars()
{
	return list_Variable(freeablevars);
}
#endif
...
#ifdef __EMSCRIPTEN__
list_Variable Simulation::getFixableVariables_list()
{
	return list_Variable(getFixableVariables());
}

list_Variable Simulation::getVariablesNearBounds_list(const double &epsilon=1e-4)
{
	return list_Variable(getVariablesNearBounds(epsilon));
}

list_Variable Simulation::getVariablesFarFromNominals_list(const double &bignum)
{
	return list_Variable(getVariablesFarFromNominals(bignum));
}

list_Variable Simulation::getFixedVariables_list()
{
	return list_Variable(getFixedVariables());
}

list_Variable Simulation::getallVariables_list()
{
	return list_Variable(getallVariables());
}

list_Variable Simulation::getFreeableVariables_list()
{
	return list_Variable(getFreeableVariables());
}
#endif
