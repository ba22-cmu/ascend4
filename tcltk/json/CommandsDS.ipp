...
#define Asc_AddCommand(i,cmdName,p,d,dp, group,usage,shorth,longh) \
  Asc_HelpDefine((cmdName), (group),(usage),(shorth),(longh))
  

#define Tcl_CmdDeleteProc void
#define ClientData int
#define Asc_CreateCommands ascjson::register_command_help
/*
 * Any new commands that need to be registered should be added here.
 */
void Asc_CreateCommands()
{
  ...
  ASCADDCOM(interp,Asc_HelpCmdHN,Asc_HelpCmd,
   "system", Asc_HelpCmdHU, Asc_HelpCmdHS, LHN(Asc_HelpCmdHC));
#if 0 //fixme
  ASCADDCOM(interp,Asc_EnvVarCmdHN,Asc_EnvVarCmd,
   "system", Asc_EnvVarCmdHU, Asc_EnvVarCmdHS, LHN(Asc_EnvVarCmdHC));
#endif
...
#if 0 // maybe embed tcl safe later
  ...
  ASCADDCOM(interp,"brow_assign", Asc_BrowRunAssignmentCmd,
    "browser",
    NULL,
    "assigns a value to to the current or search atomic instance",
    NULL
    /* the stuff above should be replaced with header macros. */
  );
